...
Public Class Class_Conectar_Base_BakApp
    ...
    Private Function Fx_Existe_Base_En_SQLServer(ByVal _Row As DataRow) As Boolean
        ...
        If Not (_Row Is Nothing) Then
            ...
            If _Reg Then
                ...
                'If Not _Sql.Fx_Existe_Tabla(_Nombre_Base & ".dbo.Zw_Licencia") Then
                '    Return False
                'End If
    ...
    Function Fx_Grabar_Base_Bakapp_En_Tabcarac() As Boolean
        ...
        Dim _Nokocarac = String.Empty
        Dim _Aceptado As Boolean

        _Aceptado = InputBox_Bk(_Formulario, "Ingrese el nombre de la" & vbCrLf & "base de datos BakApp",
                                  "Base de datos BakApp", _Nokocarac, False, _Tipo_Mayus_Minus.Normal, 0, True, _Tipo_Imagen.Texto, False)
