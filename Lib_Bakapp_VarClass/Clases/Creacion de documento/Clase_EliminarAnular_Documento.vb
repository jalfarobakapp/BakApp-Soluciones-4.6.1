...
Public Class Clase_EliminarAnular_Documento
    ...
    Function Fx_EliminarAnular_Doc(ByVal _Formulario As Form, _
            ...
            With Tabla_Doc.Rows(0)
                ...
                ElseIf _Accion = _Accion_EA.Eliminar Then
                    ...
                    Consulta_sql = "INSERT INTO MAEELIMI (EMPRESA,TIDO,NUDO,ENDO,SUENDO,FEEMDO,FEELIDO,KOFUDO,VANEDO,VABRDO)" & vbCrLf & _
                                    "Select EMPRESA,TIDO,NUDO,ENDO,SUENDO,FEEMDO,'" & _Fecha_Eliminacion & "',KOFUDO,VANEDO,VABRDO" & vbCrLf & _
    ...
    Function Revisar_Si_Se_Puede_Eliminar_El_Documento(ByVal _Formulario As Form, _
                                                               ByVal _Idmaeedo As Integer, _
                                                               ByVal _Accion As _Accion_EA, _
            ...
            If CBool(Tabla.Rows.Count) Then
                If _Mostrar_Mensaje Then
                    MessageBoxEx.Show(_Formulario, _
                                      "El documento es sustentatorio de otro documento" & vbCrLf & _
                                      "No es posible " & _Accion.ToString & " documento", _
                                      UCase(_Accion) & " DOCUMENTO", _
