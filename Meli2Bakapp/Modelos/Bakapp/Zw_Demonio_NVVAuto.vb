Public Class Zw_Demonio_NVVAuto
    Public Property Id_Enc As Integer
    Public Property IdmaeedoOCC_Ori As Integer
    Public Property NudoOCC_Ori As String
    Public Property Endo_Ori As String
    Public Property Suendo_Ori As String
    Public Property FechaGrab As DateTime?
    Public Property GenerarNVV As Boolean
    Public Property NVVGenerada As Boolean
