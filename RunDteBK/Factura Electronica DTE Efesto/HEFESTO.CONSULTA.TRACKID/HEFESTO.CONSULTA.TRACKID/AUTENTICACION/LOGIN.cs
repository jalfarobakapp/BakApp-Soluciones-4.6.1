...
namespace HEFESTO.CONSULTA.TRACKID
{
        ...
        public class LOGIN
        {
            ...
            /// </summary>
            /// <param name="certificado">Certificado del usuario que consulta</param>
            /// <returns>Token del SII</returns>
                        ...
                        if (!string.IsNullOrEmpty(signedSeed))
                        {
                            ...
                            if (ambiente == SIIAmbiente.Certificacion)
                            {
                                ...
                                if (!string.IsNullOrEmpty(valorRespuesta))
                                {
                                    ...
                                    respuesta = FUNCIONES.leerRespuestaToken(valorRespuesta);
                    ...
                    try
                    {
                        ...
                        switch (modo)
                        {
                            case SIIAmbiente.Certificacion:
                                ...
                                respuesta = FUNCIONES.leerRespuestaSeed(respuesta);
                                break;
            ...
            private static string FirmarSemilla(string seed, string cn)
            {
                ...
                X509Certificate2 certificado = FUNCIONES.obtenerCertificado(cn);

                ////
                //// Firme la semilla.
                try
                {
                    resultado = FUNCIONES.firmarDocumentoSemilla(body, certificado);
                }
                catch (Exception)
                {
