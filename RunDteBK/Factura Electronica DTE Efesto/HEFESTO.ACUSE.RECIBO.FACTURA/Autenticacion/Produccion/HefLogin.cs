...
namespace Hefesto.Acuse.Recibo.Factura.Autenticacion.Produccion
{
    /// <summary>
    /// Login de usuario
    /// </summary>
    internal class HefLogin
    {
        ...
        internal static Respuesta RecuperarSemillaSII()
        {
            ...
            ////
            //// Establesca los protocolos de seguridad
            ...
            while (intentos <= 10)
            {
                ...
                try
                {
                    ...
                    SemillaProduccion.CrSeedService palena = new SemillaProduccion.CrSeedService();
