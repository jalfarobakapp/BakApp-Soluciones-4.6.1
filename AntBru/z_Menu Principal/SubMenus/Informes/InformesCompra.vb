...
Public Class InformesCompra
    ...
    Private Sub Btn_Informe_Vencimiento_Compras_Click(sender As System.Object, e As System.EventArgs) Handles Btn_Informe_Vencimiento_Compras.Click
    ...
    Private Sub Btn_Informe_Analisis_Recepcion_vs_Despacho_Click(sender As System.Object, e As System.EventArgs)
        Dim _Analisis As New Class_Informe_Analisis_Recepcion_Vs_Despacho
        _Analisis.Sb_Generar_Reporte(_Fm_Menu_Padre, 1)
    End Sub

    Private Sub Btn_Proximas_Recepciones_Click(sender As System.Object, e As System.EventArgs) Handles Btn_Proximas_Recepciones.Click
