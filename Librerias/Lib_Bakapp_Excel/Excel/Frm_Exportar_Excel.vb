...
Public Class Frm_Exportar_Excel
    ...
    Public Sub New(ByVal Tbl_Excel As DataTable, Directorio_Destino As String)
        ...
        _Directorio_Destino = Directorio_Destino 'Application.StartupPath & "\Data\" & RutEmpresa & "\Tmp\Excel"
