...
Public Class Frm_Archivos_Adjuntos
    ...
    Public Property Pro_Editar As Boolean
        ...
        Set(value As Boolean)
            _Editar = value
            Btn_Subir_Archivos.Enabled = _Editar
            Btn_Mnu_Eliminar_Archivo.Enabled = _Editar
        End Set
    End Property

    Public Sub New(Estado As String, Sub_Estado As String)
    ...
    Private Sub Frm_Archivos_Adjuntos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                ...
                If .ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    For Each _Archivo As String In .SafeFileNames
                        ...
                        Dim _Id_Archivos As Integer = _Sql.Fx_Trae_Dato(_Global_BaseBk & "Zw_Reclamo_Archivos", "Id_Archivos",
                                                      "Id_Reclamo = " & _Id_Reclamo & " And Nombre_Archivo = '" & _Nombre_Archivo & "' And Estado = '" & _Estado & "' And Sub_Estado = '" & _Sub_Estado & "'",
                                                      True)
    ...
    Function Fx_Grabar_Observacion_Adjunta(ByVal _Ruta As String,
        ...
        Try
            ...
            cmd.CommandText = "INSERT INTO " & _Global_BaseBk &
                              "Zw_Reclamo_Archivos (Id_Reclamo,Nombre_Archivo,Archivo,Estado,Sub_Estado) VALUES " &
                              "(@Id_Reclamo,@Nombre_Archivo,@Archivo,@Estado,@Sub_Estado)"
            ...
            cmd.Parameters.AddWithValue("@Sub_Estado", _Sub_Estado)
