    ...
    Function Fx_Fijar_Estado() As Boolean
        ...
        Try
            ...
            If _Accion = Accion.Nuevo Then
                ...
                Consulta_sql = _
                               "Update " & _Global_BaseBk & "Zw_St_OT_Encabezado Set" & vbCrLf & _
                               "CodEstado = 'A',CodTecnico_Asignado = '" & Cmb_Tecnico.SelectedValue & "'" & vbCrLf & _
                               ...
                               "(" & _Id_Ot & ",'A',GetDate(),'" & FUNCIONARIO & "','" & Nombre_funcionario_activo & "')" & vbCrLf & _
                               "Update " & _Global_BaseBk & "Zw_St_OT_Notas Set Nota_Etapa_02 = '" & _Nota_Etapa_02 & "'" & vbCrLf & _
                               "Where Id_Ot = " & _Id_Ot
            ...
            ElseIf _Accion = Accion.Editar Then
                ...
                Consulta_sql = "Update " & _Global_BaseBk & "Zw_St_OT_Encabezado Set" & vbCrLf & _
                               "CodTecnico_Asignado = '" & Cmb_Tecnico.SelectedValue & "'," & vbCrLf & _
                               "Pais = '" & _Pais & "'," & vbCrLf & _
                               "Ciudad = '" & _Ciudad & "'," & vbCrLf & _
                               "Comuna = '" & _Comuna & "'," & vbCrLf & _
                               "Direccion = '" & _Direccion & "'" & vbCrLf & _
                               "Where Id_Ot = " & _Id_Ot & vbCrLf & _
                               "Update " & _Global_BaseBk & "Zw_St_OT_Notas Set Nota_Etapa_02 = '" & _Nota_Etapa_02 & "'" & vbCrLf & _
                               "Where Id_Ot = " & _Id_Ot
