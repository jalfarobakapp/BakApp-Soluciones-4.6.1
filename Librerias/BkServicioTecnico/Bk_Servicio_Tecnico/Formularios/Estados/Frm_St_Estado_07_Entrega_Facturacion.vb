...
#End Region
    ...
    Function Fx_Fijar_Estado() As Boolean
        ...
        Consulta_sql += "Delete " & _Global_BaseBk & "Zw_St_OT_Doc_Asociados" & Space(1) & _
                        "Where Id_Ot = " & _Id_Ot & " And Tido IN ('FCV','GDI') And Garantia = 0" & vbCrLf & vbCrLf
