...
Public Class Frm_St_Estado_05_Reparacion
    ...
    Private Sub Frm_St_Estado_05_Reparacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#End Region
    ...
    Private Sub Btn_Fijar_Estado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Fijar_Estado.Click
        ...
        If Fx_Se_Puede_Grabar() Then
            ...
            Else
                ...
                If MessageBoxEx.Show(Me, "Marco la casilla <<NO SE PUDO REPARAR EL EQUIPO>>" & vbCrLf & _
                                     "¿Está seguro de fijar el estado?", "Equipo No reparado", MessageBoxButtons.YesNoCancel, _
    ...
    Function Fx_Se_Puede_Grabar() As Boolean
        ...
        If String.IsNullOrEmpty(Txt_Reparacion_Realizada.Text) Then
            Beep()
            ToastNotification.Show(Me, "FALTA INFORME DE REPARACION REALIZADA", _
            ...
            If CBool(_Tbl_DetProd_Cov.Rows.Count) Then
                ...
                For Each _Fila As DataRow In _Tbl_DetProd_Cov.Rows
                    ...
                    If Not _Chk_Validado Then
                        MessageBoxEx.Show(Me, "confirmar las cantidades utilizadas en la reparación" & vbCrLf & _
                                            "reingresando las cantidades de cada producto utilizado.", _
                                                        "Faltan productos por validar", MessageBoxButtons.OK, _
                                                        MessageBoxIcon.Stop)
    ...
    Private Sub Grilla_CellEndEdit(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
        ...
        If _Cabeza = "Cantidad_Utilizada" Then
            ...
            Else
                If _Cantidad_Utilizada < 0 Then
                    MessageBoxEx.Show(Me, "La cantidad ingresada no puede ser negativa", "Validación", _
                ...
                Else
                    If _Cantidad_Utilizada > _Cantidad Then
                        MessageBoxEx.Show(Me, "La cantidad ingresada no puede ser mayor a la cantidad del documento", "Validación", _
                                          MessageBoxButtons.OK, MessageBoxIcon.Stop)
                        _Fila.Cells("Cantidad_Utilizada").Value = _Cantidad
                        _Fila.Cells("Utilizado").Value = False
                        _Fila.Cells("Chk_Validado").Value = False
    ...
    Private Sub Chk_No_se_pudo_reparar_el_equipo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

        If Chk_No_se_pudo_reparar_el_equipo.Checked Then

            Dim _Motivo As String = InputBox_Bk(Me, "Motivo del problema", "", _
                                                _Motivo_no_reparo, True, _Tipo_Mayus_Minus.Mayusculas, 300, _
                                                True, _Tipo_Imagen.Texto, False)

            If _Motivo <> "@@Accion_Cancelada##" Then
    ...
    Function Fx_Fijar_Estado() As Boolean
        ...
        Consulta_sql = "Update " & _Global_BaseBk & "Zw_St_OT_Notas Set " & vbCrLf & _
                       "Nota_Etapa_05 = '" & _Nota_Etapa_05 & _
                       "',Chk_no_se_pudo_reparar = " & _Chk_no_se_pudo_reparar & vbCrLf & _
                       ",Reparacion_Realizada = '" & _Reparacion_Realizada & "'" & vbCrLf & _
                       ",Motivo_no_reparo = '" & _Motivo_no_reparo & "'" & vbCrLf & _
        ...
        Consulta_sql += "Update " & _Global_BaseBk & "Zw_St_OT_Encabezado Set " & _
                       "CodTecnico_Repara = '" & Cmb_Tecnico.SelectedValue & "'," & vbCrLf & _
        ...
        For Each _Fila_Cov As DataRow In _Tbl_DetProd_Cov.Rows
            ...
            Consulta_sql += "Insert Into " & _Global_BaseBk & "Zw_St_OT_DetProd (Id_Ot,Utilizado,Codigo,Descripcion," & _
                           ...
                           "(" & _Id_Ot & "," & _Utilizado & ",'" & _Codigo & "','" & _Descripcion & _
                           "'," & De_Num_a_Tx_01(_Cantidad, False, 5) & _
                           "," & De_Num_a_Tx_01(_Cantidad_Utilizada, False, 5) & _
                           ",'" & _Ud & "'," & _Un & _
                           ...
                           "," & De_Num_a_Tx_01(_Total_Linea, False, 5) & _
    ...
    Function Fx_Fijar_Estado_No_Se_Pudo_Reparar() As Boolean
        ...
        Consulta_sql = "Update " & _Global_BaseBk & "Zw_St_OT_Encabezado Set" & Space(1) & _
                       "CodEstado = 'V'," & vbCrLf & _
                       "CodTecnico_Repara = '" & Cmb_Tecnico.SelectedValue & "'," & vbCrLf & _
                       "Horas_Mano_de_Obra_Repara = 0," & vbCrLf & _
                       "Fecha_Cierre = Getdate()" & vbCrLf & _
                       "Where Id_Ot = " & _Id_Ot & vbCrLf & vbCrLf

        Consulta_sql += "Update " & _Global_BaseBk & "Zw_St_OT_Notas Set " & vbCrLf & _
                        "Nota_Etapa_05 = '" & _Texto & "'" & vbCrLf & _
                        ",Motivo_no_reparo = '" & _Motivo_no_reparo & "'" & vbCrLf & _
                        ",Chk_no_se_pudo_reparar = " & _Chk_no_se_pudo_reparar & vbCrLf & _
                        ",Nota_Etapa_06 = '" & _Texto & "'" & vbCrLf & _
                        ",Nota_Etapa_07 = '" & _Texto & "'" & vbCrLf & _
                        "Where Id_Ot = " & _Id_Ot & vbCrLf & vbCrLf
    ...
    Private Sub Frm_St_Estado_05_Reparacion_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Btn_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Grabar.Click
        If Fx_Se_Puede_Grabar() Then
            If Fx_Fijar_Estado() Then
                ...
                MessageBoxEx.Show(Me, "Datos actualizados correctamente", "Editar", _
                                  MessageBoxButtons.OK, MessageBoxIcon.Information)
