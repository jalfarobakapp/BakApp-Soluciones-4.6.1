...
Public Class Clase_Crear_Documento_PDF

    Dim _Sql As New Class_SQL(Cadena_ConexionSQL_Server)

    Sub Generar_PDF(ByVal Dset_DTE As DataSet, _
        ...
        Try
            ...
            For Each _DTE_Fila As DataRow In Tbl_Encabezado.Rows
                ...
                'AppPath() & "\Data\" & RutEmpresa & "\DTE2PDF\"
                Dim Archivo As String = _Ruta_Archivo & Nombre_Archivo_PDF & _Documento_Id & ".pdf"
                ...
                With Tbl_Emisor
                    ...
                    Dim _Tido As String = Trim(.Rows(_Encabezado_Id).Item("Tido"))
                    ...
                    _Tipo_Documento = _Sql.Fx_Trae_Dato("TABTIDO", "NOTIDO", "TIDO = '" & _Tido & "'") 'Tipo_Documento(_Id_Doc)
