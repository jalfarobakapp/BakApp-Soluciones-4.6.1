...
Partial Class Frm_Cadenas_Remotas_Buscador
    ...
    Private Sub InitializeComponent()
        ...
        Me.Grupo_Numero.Text = "Filtro por número de solicitud remota"
        '
        'TableLayoutPanel7
        '
        ...
        Me.LabelX11.Text = "Número de solicitud"
        '
        'Txt_Numero
        '
        ...
        Me.Grupo_Otros_Filtros.Text = "Filtros Entidades, Técnicos y Estados"
        '
        'TableLayoutPanel4
        '
