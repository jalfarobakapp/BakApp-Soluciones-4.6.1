...
Public Class Frm_Arbol_Lista
    ...
    Sub Sb_Cargar_Arbol_Advt()
        ...
        Dim _NodoRaiz_Advt As AdvTree.Node ' TreeNode
    ...
    Sub Sb_Cargar_Nodos_Advt(_Nodo_Padre As AdvTree.Node, _Clas_Unica_X_Producto As Boolean)
        ...
        For Each _Fila As DataRow In _Tbl.Rows
            ...
            If _Es_Seleccionable Then
                ...
                If _Es_Seleccionable AndAlso (ModoRadioButton Or ModoCheckButton) Then
                ...
                _Nodo = Fx_CrearNodo_Advt(_Codigo_Nodo, _Descripcion, _Checked, _Es_Seleccionable, 7, 8)

            Else
                _Nodo = Fx_CrearNodo_Advt(_Codigo_Nodo, _Descripcion, _Checked, _Es_Seleccionable, 0, 0)
            End If
    ...
    Function Fx_CrearNodo_Advt(_Name As String,
        ...
        With _Nodo
            ...
            If Not _Tag Then '_CheckBoxVisible Then
                .Image = _Imagen1
    ...
    Private Sub Btn_CrearClasificacion_Click(sender As Object, e As EventArgs) Handles Btn_CrearClasificacion.Click
        ...
        If _Grabar Then
            ...
            If _Row.Item("Es_Seleccionable") Then
                _NewNodo = Fx_CrearNodo_Advt(_Codigo_Nodo, _Descripcion, True, True, 7, 8)
            Else
                _NewNodo = Fx_CrearNodo_Advt(_Codigo_Nodo, _Descripcion, False, False, 0, 0)
            End If
    ...
    Private Sub Btn_EliminarClasificacion_Click(sender As Object, e As EventArgs) Handles Btn_EliminarClasificacion.Click
        ...
        If _Mensaje.EsCorrecto Then
            Tree_Bandeja_Adv.Nodes.Remove(_Nodo)
        End If
    ...
    Private Sub Adv_Tree_Bandeja_NodeMouseDown(sender As Object, e As AdvTree.TreeNodeMouseEventArgs) Handles Tree_Bandeja_Adv.NodeMouseDown
        ...
        If e.Button = MouseButtons.Right Then
            ...
            If ModoRadioButton Or ModoCheckButton Then
                Return
            End If
    ...
    Private Sub Tree_Bandeja_Adv_AfterCheck(sender As Object, e As AdvTree.AdvTreeCellEventArgs) Handles Tree_Bandeja_Adv.AfterCheck
        ...
        If ModoCheckButton Or ModoRadioButton Then
            Dim _Checkeados As Boolean
            For Each _nd As AdvTree.Node In _Nodo.Parent.Nodes
                If _nd.Checked Then
                    _Checkeados = True
                    Exit For
                End If
            Next
            If _Checkeados Then
                _Nodo.Parent.CheckState = CheckState.Indeterminate
            Else
                _Nodo.Parent.CheckState = CheckState.Unchecked
            End If
        End If
