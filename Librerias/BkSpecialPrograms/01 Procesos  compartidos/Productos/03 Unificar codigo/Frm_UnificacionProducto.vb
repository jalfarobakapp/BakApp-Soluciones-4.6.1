...
#End Region
    ...
    Private Sub Unificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Unificar.Click
        ...
        Dim info As New TaskDialogInfo("¡ADVERTENCIA!", _
                                     eTaskDialogIcon.ShieldStop, _
                                     "¡IMPORTANTE!", _
                                     "Esta acción reemplaza el código antiguo por el nuevo en todos sus movimientos de existencia y a demas deja el código anterior como alternativo para el nuevo código, es decir, los códigos anteriores al leerlos con el sistema automaticamente te llevaran al nuevo código." & vbCrLf & _
                                     "Esta acción requiere de mucha seguridad, ya que la transacción es irreversible" & vbCrLf & vbCrLf & _
                                     "¿DESEA REALIZAR EL CAMBIO?" & vbCrLf, _
                ...
                If CBool(Reg) Then
                    ...
                    If _Cancelar_LevMasivo Then
                        ...
                        Dim dlg As System.Windows.Forms.DialogResult = _
                                        ...
                                        "¿Esta seguro de cancelar esta acción, esto quitara todo lo incorporado?", _
