...
Public Class Frm_Adjuntar_Archivos_X_Productos
    ...
    Private Sub Sb_Actualizar_Grilla()
        ...
        Consulta_sql = "Select Id,Codigo,Nombre_Archivo,DATALENGTH(Archivo) As Tamano,Cast('' As Varchar(50)) As Size" & vbCrLf &
                ...
                With oFD
                    ...
                    If .ShowDialog = System.Windows.Forms.DialogResult.OK Then
                        ...
                        For Each _Archivo As String In .SafeFileNames
                            ...
                            Dim _Id As Integer = _Sql.Fx_Trae_Dato(_Global_BaseBk & "Zw_Prod_Archivos", "Id",
                                                 "Codigo = '" & _Codigo & "' And Nombre_Archivo = '" & _Nombre_Archivo & "'", True)
                            ...
                            If CBool(_Id) Then
                                If MessageBoxEx.Show(Me, "Archivo: " & _Nombre_Archivo & vbCrLf &
                                    ...
                                    Consulta_sql = "Delete " & _Global_BaseBk & "Zw_Prod_Archivos Where Id = " & _Id
    ...
    Function Fx_Grabar_Observacion_Adjunta(ByVal _Ruta As String,
        ...
        Try
            ...
            cmd.CommandText = "INSERT INTO " & _Global_BaseBk &
                              "Zw_Prod_Archivos (Codigo,Nombre_Archivo,Archivo) VALUES " &
                              "(@Codigo,@Nombre_Archivo,@Archivo)"
        ...
        If CBool(Grilla_Archivos.SelectedRows.Count) Then
            ...
            If Not String.IsNullOrEmpty(_Directorio_Destino) Then
                ...
                For Each _Fila As DataGridViewRow In Grilla_Archivos.SelectedRows
                    ...
                    If Fx_Extrae_Archivo_desde_BD(_Id, _Nombre_Archivo, _Directorio_Destino) Then
                        _Bajados += 1
    ...
    Private Sub Btn_Mnu_Eliminar_Archivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Mnu_Eliminar_Archivo.Click
        ...
        If Fx_Tiene_Permiso(Me, "Prod047") Then
            ...
            For Each _Fila As DataGridViewRow In Grilla_Archivos.SelectedRows
                ...
                Consulta_sql += "Delete " & _Global_BaseBk & "Zw_Prod_Archivos Where Id = " & _Id & vbCrLf
