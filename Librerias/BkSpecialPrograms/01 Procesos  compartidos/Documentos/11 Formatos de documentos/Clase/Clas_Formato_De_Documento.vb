...
Public Class Clas_Formato_De_Documento
    ...
    Function Fx_Editar_Imagen(ByVal _Ruta_Imagen As String) As Boolean
        ...
        Using OpenFileDialog1 As New OpenFileDialog()
            ...
            With OpenFileDialog1
                ...
                If .ShowDialog = DialogResult.OK Then
                    ...
                    Dim _Old_Archivo = .FileName
                    'Dim _New_Archivo = _Ruta_Imagen & "\" & .SafeFileName

                    'My.Computer.FileSystem.CopyFile(_Old_Archivo, _New_Archivo)

                    _RutaImagen = _Old_Archivo
                    Return True
                End If
            End With
