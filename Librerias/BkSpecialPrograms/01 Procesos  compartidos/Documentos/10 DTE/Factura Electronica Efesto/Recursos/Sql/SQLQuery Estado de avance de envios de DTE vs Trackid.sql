...
Select Cast(0 As Int) As Existe, 
        ...
        Case When Edo.ESDO = 'N' Then 'Documento NULO' Else Case When Doc.ErrorEnvioDTE = 0 Then Isnull(Tid.Respuesta,Isnull(Doc.Respuesta,'')) Else Isnull(Doc.Respuesta,'') End End As 'Respuesta',
