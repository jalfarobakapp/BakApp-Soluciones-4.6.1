...
--Insert Into #Paso
--Select EMPRESA,KOSU,KOBO,LTRIM(RTRIM(KOSU))+'-'+LTRIM(RTRIM(KOBO)),@Codigo,0,0,0,0,0,0,0,'' From TABBO WHere EMPRESA+KOSU+KOBO Not In (Select EMPRESA+KOSU+KOBO From #Paso)
