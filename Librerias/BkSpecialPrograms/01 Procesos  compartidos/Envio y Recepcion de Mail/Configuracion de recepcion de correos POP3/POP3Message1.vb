...
Module POP3Message1
    ...
    Public Function connect(ByVal _Host As String, _
                            ByVal _Usuario As String, _
                            ByVal _Pass As String) As Integer

        Dim POP3Account As String
        POP3Account = _Host '"mail.mavensystems.biz"
        ...
        Dim user As String
        user = _Usuario '"test@mavensystems.biz"
        ...
        password = _Pass '"test1234"
        data = "PASS " & password & vbCrLf
        szData = System.Text.Encoding.ASCII.GetBytes(data.ToCharArray())
        NetStrm.Write(szData, 0, szData.Length)
        POPResponse = RdStrm.ReadLine
        If POPResponse.Substring(0, 3) = "-ERR" Then
