...
Public Class ProdNoContados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BkSpecialPrograms.ProdNoContados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProdNoContados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProdNoContados = New ProdNoContados()
        rpt.Site = Me.Site
        Return rpt
    End Function
