...
Public Class ProdContados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BkSpecialPrograms.ProdContados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProdContados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProdContados = New ProdContados()
        rpt.Site = Me.Site
        Return rpt
    End Function
