...
Public Class Frm_Mt_InvParc_SelecionFechas
    ...
    Sub Sb_Seleccionar_Inventario()
        ...
        If _Estado Then
            ...
            If String.IsNullOrEmpty(_Nudo_GRI) Or String.IsNullOrEmpty(_Nudo_GDI) Then
                ...
                MessageBoxEx.Show(Me, "Debe revisar la numeración para las guías de ajuste GRI o GDI." & vbCrLf & _
                                  "Revise la numeración de la configuración de estación", _
            ...
            Fm.Dispose()
        Else
            MessageBoxEx.Show(Me, "Este ajuste se encuentra cerrado", "Validación", _
    ...
    Private Sub Btn_Mnu_Eliminar_Ajuste_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Mnu_Eliminar_Ajuste.Click
        ...
        Dim dlg As System.Windows.Forms.DialogResult = _
                      MessageBoxEx.Show(Me, "¿Esta seguro de eliminar la(s) fila(s) seleccionada(s)?", _
