...
Public Class Dte2Imp_
        ...
        If Extencion = "xml" Then
            ...
            If String.IsNullOrEmpty(_Validacion) Then
                ...
                If Not El_Archivo_Esta_Abierto(_File) Then
                    ...
                    MessageBoxEx.Show("Documento seleccionado correctamente", "Documento DTE.xml", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Sub Generar_Old(ByVal Dset_DTE As DataSet, _
                ByVal Nombre_Archivo_PDF As String, _
                ByVal _Marca_Agua As String, _
                Optional ByVal Imprimir_Regleta As Boolean = False, _
                Optional ByVal _Poner_Marca_de_agua As Boolean = False)

        Try


            Dim Tbl_Encabezado = Dset_DTE.Tables("Encabezado")
            ...
            For Each _DTE_Fila As DataRow In Tbl_Encabezado.Rows
                ...
                Dim Archivo As String = AppPath() & "\Data\" & RutEmpresa & "\DTE2PDF\" & Nombre_Archivo_PDF & _Documento_Id & ".pdf"
                ...
                Dim Tbl_IdDoc = Dset_DTE.Tables("IdDoc") '.Select("Encabezado_Id = 0")
                ...
                Dim Tbl_Emisor = Dset_DTE.Tables("Emisor")
                ...
                Dim _Fecha_Vencimienti As Date

                Try
                    _Fecha_Vencimienti = Tbl_IdDoc.Rows(_Encabezado_Id).Item("FchVenc")
                Catch ex As Exception
                    If MessageBoxEx.Show(Me, "Documento sin fecha de vencimiento" & vbCrLf & _
                                    "¿Desea ingresar la fecha de vencimiento?", "Validación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        Try
                            _Fecha_Vencimienti = InputBox("Ingrese fecha de vencimiento del documento en formato dd/mm/aaaa o dd-mm-aaaa", _
                                                      "Fecha de vencimiento", _Fecha_Emision)
                        Catch exx As Exception
                            MessageBoxEx.Show(exx.Message)
                            _Fecha_Vencimienti = Nothing
                        End Try
                    Else
                        _Fecha_Vencimienti = Nothing
                    End If
                ...
                Dim Tbl_Receptor = Dset_DTE.Tables("Receptor")
                ...
                'Dset_DTE(NmbItem)
                Dim Tbl_Detalle = Dset_DTE.Tables("Detalle")
                Dim Tbl_CdgItem = Dset_DTE.Tables("CdgItem")
                ...
                For Each Fila As DataRow In Tbl_Detalle.Rows
                    ...
                    If Id = _Documento_Id Then
                        ...
                        If Not (Tbl_CdgItem Is Nothing) Then
                            _Codigo = Trim(Tbl_CdgItem.Rows(_Detalle_Id).Item("VlrCodigo"))
                        End If
                        ...
                        Dim _Descripcion As String = Trim(Fila.Item("NmbItem"))

                        If Len(_Descripcion) > 50 Then
                            _Descripcion = Mid(_Descripcion, 1, 60) & "..."
                        End If

                        Dim _Precio As Double = Valor_Columna(Fila, 0, "PrcItem", True) 'De_Txt_a_Num_01(Fila.Item("PrcItem"))
                        ...
                        Dim _Monto As Double = Valor_Columna(Fila, 0, "MontoItem", True) 'De_Txt_a_Num_01(Fila.Item("MontoItem"))
                ...
                '''''''''''''''''''''''''''''' REFERENCIA 
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                Dim Tbl_Referencia = Dset_DTE.Tables("Referencia")
                ...
                Dim Tbl_ImptoReten = Dset_DTE.Tables("ImptoReten")
                ...
                Dim Tbl_Totales = Dset_DTE.Tables("Totales")
                ...
                Dim _TED = Dset_DTE.Tables("TED")
                Dim _DD = Dset_DTE.Tables("DD")
                Dim _CAF = Dset_DTE.Tables("CAF")
                Dim _DA = Dset_DTE.Tables("DA")
                Dim _RNG = Dset_DTE.Tables("RNG")
                Dim _RSAPK = Dset_DTE.Tables("RSAPK")
                Dim _FRMA = Dset_DTE.Tables("FRMA")



                Dim _Timbre As String = "<DD><RE>" & _DD.Rows(_Documento_Id).Item("RE") & "</RE><TD>" & _DD.Rows(_Documento_Id).Item("TD") & "</TD><F>" & _DD.Rows(_Documento_Id).Item("F") & _
            ...
            Next
        Catch ex As Exception
            MessageBoxEx.Show(Me, ex.Message & vbCrLf & _
    ...
    Sub Generar(ByVal Dset_DTE As DataSet,
                ByVal Nombre_Archivo_PDF As String,
                ByVal _Marca_Agua As String,
                Optional ByVal Imprimir_Regleta As Boolean = False,
                Optional ByVal _Poner_Marca_de_agua As Boolean = False)
        ...
        Try
            ...
            For Each _DTE_Fila As DataRow In Tbl_Encabezado.Rows
                ...
                Try
                    _Fecha_Vencimienti = Tbl_IdDoc.Rows(_Encabezado_Id).Item("FchVenc")
                Catch ex As Exception
                    If MessageBoxEx.Show(Me, "Documento sin fecha de vencimiento" & vbCrLf &
                                    "¿Desea ingresar la fecha de vencimiento?", "Validación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        Try
                            _Fecha_Vencimienti = InputBox("Ingrese fecha de vencimiento del documento en formato dd/mm/aaaa o dd-mm-aaaa",
                                                      "Fecha de vencimiento", _Fecha_Emision)
                        Catch exx As Exception
                            MessageBoxEx.Show(exx.Message)
                            _Fecha_Vencimienti = Nothing
                ...
                For Each Fila As DataRow In Tbl_Detalle.Rows
                    ...
                    If Id = _Documento_Id Then
                        ...
                        If _Descripcion.Length > 63 Then
                            ...
                            '_Descripcion = Mid(_Descripcion, 1, 70) & "..."
                        ...
                        If Len(_Descripcion) > 63 Then
                            ...
                            'pgfx.DrawString(_Descripcion, FteNormal_C_6, XBrushes.Black, 140, Ypos)
    ...
    Function Fx_New_Validar_DTE(ByVal _Archivo_Xml As String) As String
        ...
        Try
            ...
            For Each m_node In m_nodelist 'm_nodelist
                ...
                Dim XmlRut = m_xmld.SelectSingleNode("sii:DTE[" & _Id & _
    ...
    Private Function Tipo_Documento(ByVal _Id_Doc As String)
        Select Case _Id_Doc
            Case 33
                Return "FACTURA"
            Case 34
    ...
    Private Function Tipo_Referencia(ByVal _Cod_Ref As Integer)
    ...
    Private Function El_Archivo_Esta_Abierto(ByVal filePath As String) As Boolean
    ...
    Private Function Valor_Columna(ByVal _Tabla As DataRow, _
                                   ByVal Fila As Integer, _
                                   ByVal _Campo As String, _
                                   Optional ByVal _EsNro As Boolean = False)
