Public Class Cl_ConfCorreoAviso
    ...
    Public Property Zw_Demonio_Cof_Correo As New Zw_Demonio_Cof_Correo
    ...
    Function Fx_Llenar_ConfCorreo(_Id_ConfCorreo As Integer) As LsValiciones.Mensajes
        ...
        Consulta_sql = "Select * From " & _Global_BaseBk & "Zw_Demonio_Cof_Correo Where Id = " & _Id_ConfCorreo
        Dim _Row As DataRow = _Sql.Fx_Get_DataRow(Consulta_sql)

        If IsNothing(_Row) Then

            _Mensaje.EsCorrecto = False
            _Mensaje.Mensaje = "No se encontraron registros en la tabla Zw_Demonio_Cof_Correo con el Id " & _Id_ConfCorreo
        ...
        _Mensaje.Tag = Zw_Demonio_Cof_Correo

        Return _Mensaje

    End Function

    Function Fx_Grabar_Nuevo_ConfCorreo(_Zw_Demonio_Cof_Correo As Zw_Demonio_Cof_Correo) As LsValiciones.Mensajes
        ...
        Try
            ...
            With _Zw_Demonio_Cof_Correo
                ...
                Consulta_sql = "Insert Into " & _Global_BaseBk & "Zw_Demonio_Cof_Correo (NombreEquipo,Id_Padre,Nombre_ConfCorreo,Id_Correo,Nombre_Correo," &
                ...
                "CC_EntidadDoc) Values ('" & .NombreEquipo & "'," & .Id_Padre & ",'" & .Nombre_ConfCorreo & "'," & .Id_Correo & ",'" & .Nombre_Correo & "'," &
    ...
    Function Fx_Editar_ConfCorreo(_Id_ConfCorreo As Integer, _NuevaConfiguracion As Zw_Demonio_Cof_Correo) As LsValiciones.Mensajes

        Dim _Mensaje As New LsValiciones.Mensajes

        Try
            Consulta_sql = "Update " & _Global_BaseBk & "Zw_Demonio_Cof_Correo Set " &
    ...
    Function Fx_Eliminar_ConfCorreo(_Id_ConfCorreo As Integer) As LsValiciones.Mensajes
        ...
        Try
            Consulta_sql = "Delete From " & _Global_BaseBk & "Zw_Demonio_Cof_Correo Where Id = " & _Id_ConfCorreo
