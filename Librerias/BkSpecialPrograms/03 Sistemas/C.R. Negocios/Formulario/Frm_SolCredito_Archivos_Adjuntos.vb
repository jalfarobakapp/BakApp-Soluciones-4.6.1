...
Public Class Frm_SolCredito_Archivos_Adjuntos
    ...
    Public Sub New(ByVal NroNegocio As String, ByVal Bloqueada As Boolean)
        ...
        If _Bloqueada Then
            Btn_Subir_Archivos.Visible = False
    ...
    Private Sub Sb_Actualizar_Grilla()
        ...
        'Consulta_sql = "Select Id,Codigo,Nombre_Archivo,DATALENGTH(Archivo) As Tamano,Cast('' As Varchar(50)) As Size" & vbCrLf & _
        '               "From " & _Global_BaseBk & "Zw_Prod_Archivos" & vbCrLf & _
        '               "Where Codigo = '" & _Row_Producto.Item("KOPR") & "'"

        Consulta_sql = "Select Semilla,Nom_Documento,DATALENGTH(Archivo) As Tamano,Cast('' As Varchar(50)) As Size,Fecha From " & _Global_BaseBk & "Zw_Negocios_04_Doc" & vbCrLf & _
        ...
        With Grilla_Archivos
            ...
            .Columns("Nom_Documento").HeaderText = "Nombre del archivo"
            .Columns("Nom_Documento").Width = 430
        ...
        For Each _Fila As DataGridViewRow In Grilla_Archivos.Rows
            ...
            Dim _Nombre_Archivo As String = _Fila.Cells("Nom_Documento").Value
    ...
    Private Sub Btn_Subir_Archivos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Subir_Archivos.Click
        ...
        If Fx_Tiene_Permiso(Me, "Prod046") Then
                ...
                With oFD
                    ...
                    If .ShowDialog = System.Windows.Forms.DialogResult.OK Then
                        ...
                        For Each _Archivo As String In .SafeFileNames
                            ...
                            Dim _Semilla As Integer = _Sql.Fx_Trae_Dato(_Global_BaseBk & "Zw_Negocios_04_Doc", "Semilla", _
                                                 "NroNegocio = '" & _NroNegocio & "' And Nom_Documento = '" & _Nombre_Archivo & "'", True)

                            If CBool(_Semilla) Then
                                If MessageBoxEx.Show(Me, "Archivo: " & _Nombre_Archivo & vbCrLf & _
                                                     "¿Desea reemplazarlo?", "El archivo ya existe", _
                            ...
                            If _Subir_Archivo Then
                                Fx_Grabar_Observacion_Adjunta(_NroNegocio, _Ruta, _Nombre_Archivo, Tipo_Obs.ADJUNTO)
                            End If
        ...
        If CBool(Grilla_Archivos.SelectedRows.Count) Then
            ...
            If Not String.IsNullOrEmpty(_Directorio_Destino) Then
                ...
                For Each _Fila As DataGridViewRow In Grilla_Archivos.SelectedRows
                    ...
                    Dim _Nom_Documento = _Fila.Cells("Nom_Documento").Value
                    Dim _Semilla = _Fila.Cells("Semilla").Value

                    If Fx_Extrae_Archivo_desde_BD(_Semilla, _Nom_Documento, _Directorio_Destino) Then
                        _Bajados += 1
    ...
    Function Fx_Extrae_Archivo_desde_BD(ByVal _Semilla As Integer, _
        ...
        Try
            ...
            Using cn As New SqlConnection
                ...
                'cmd.CommandText = "SELECT Archivo From " & _Global_BaseBk & "Zw_Prod_Archivos WHERE Id = " & _Id
                ' Abrimos la conexión.
                cn.Open()
    ...
    Private Sub Btn_Mnu_Eliminar_Archivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Mnu_Eliminar_Archivo.Click
        ...
        If CBool(Grilla_Archivos.SelectedRows.Count) Then
            ...
            If Grilla_Archivos.SelectedRows.Count = 1 Then
            ...
            If MessageBoxEx.Show(Me, "Esta seguro de querer eliminar " & _Mensaje, "Eliminar", _
                ...
                For Each _Fila As DataGridViewRow In Grilla_Archivos.SelectedRows
                    ...
                    Dim _Semilla = _Fila.Cells("Semilla").Value
                    Consulta_sql += "Delete " & _Global_BaseBk & "Zw_Negocios_04_Doc Where Semilla = " & _Semilla & vbCrLf
            ...
            End If
        Else
            MessageBoxEx.Show(Me, "No existen archivos en la carpeta", "Validación", _
    ...
    Private Sub Btn_Mnu_Descargar_Archivo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Mnu_Descargar_Archivo.Click
        ...
        Dim _Nombre_Archivo = _Fila.Cells("Nom_Documento").Value
        Dim _Semilla = _Fila.Cells("Semilla").Value
        ...
        If Fx_Extrae_Archivo_desde_BD(_Semilla, _Nombre_Archivo, _Path) Then
            Try
                Me.Enabled = False
    ...
    Private Sub Btn_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Eliminar.Click
        Call Btn_Mnu_Eliminar_Archivo_Click(Nothing, Nothing)
    End Sub
End Class
