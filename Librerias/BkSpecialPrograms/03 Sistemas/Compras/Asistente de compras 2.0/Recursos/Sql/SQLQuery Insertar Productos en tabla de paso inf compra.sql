...
Update #TablaPaso# Set 
                       ...
                       Nom_ClasificacionLibre = Isnull((Select Top 1 NOKOCARAC From TABCARAC 
...
Update  #TablaPaso# Set IdGDD = IsNull((Select Top 1 IDMAEDDO From MAEDDO
Where TIDO = 'GDD' And KOPRCT = Codigo And ESLIDO = '' Order By FEEMLI Desc),0)     

Update #TablaPaso# Set Fecha_Ult_Venta = Isnull((Select Max(FEEMLI) From MAEDDO Where IDMAEEDO In 
(Select IDMAEEDO From MAEEDO Where TIDO In ('BLV','BLX','BSV','ESC','FCV','FDB','FDV','FDX','FDZ','FEE','FEV','FVL','FVT','FVX','FVZ','NCE','NCV','NCX','NCZ','NEV','RIN')
#EntExcluidas#
)
And KOPRCT = Codigo
#FiltroBodegas#
