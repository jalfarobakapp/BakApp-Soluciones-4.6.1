...
Select KOLT As Padre,KOLT+'-'+NOKOLT As Hijo From TABPP Where TILT = 'C'"
    ...
    End Sub
    Sub Sb_Formato_Grilla_Compras_Nacionales4(Grilla As DataGridView)
    ...
    Function Sb_Grilla_Actualizar_Informe(Grilla As DataGridView)
        ...
        If Fm_Hijo.Cmb_Tipo_de_compra.SelectedValue = "Nacional4" Then Sb_Formato_Grilla_Compras_Nacionales4(Grilla)
...
Update {_Nombre_Tbl_Paso_Informe} Set CodigoOferta = '',NombreOferta = '',
    FechaInicioOferta = Null,FechaFinOferta = Null,OfertaActiva = 0,MontoOferta = 0;
    ...
    Function Fx_Detalle_Ult_Doc_Compras(_Tido As String,
        ...
        If Chk_MostrarFlete.Checked Then
            ...
            Consulta_sql = $"Select Top " & _Top & " IDMAEDDO,IDMAEEDO,TIDO,NUDO,ENDO,SUENDO,NOKOEN,FEEMLI,BOSULIDO,UDTRPR,UD0" & Ud & "PR As UDTRANS,UD01PR,UD02PR,
                        ...
                        Case When " & _CostoUd1 & " = 0.0000 then 0 Else Round((" & _CostoUd1 & "-(PPPRNERE1+POTENCIA))/" & _CostoUd1 & ",2) End As Porc_Dif_Precios_Neto,
...
ORDER BY Ddo.FEEMLI DESC;"
        ...
        Else
            ...
            Consulta_sql = "Select Top " & _Top & " IDMAEDDO,IDMAEEDO,TIDO,NUDO,ENDO,SUENDO,NOKOEN,FEEMLI,BOSULIDO,UDTRPR,UD0" & Ud & "PR As UDTRANS,UD01PR,UD02PR,
                        ...
                        Case When " & _CostoUd1 & " = 0.0000 then 0 Else Round((" & _CostoUd1 & "-(PPPRNERE1))/PPPRNERE1,2) End As Porc_Dif_Precios_Neto,
                        Case When " & _CostoUd1 & " = 0.0000 then 0 Else Round((" & _CostoUd1 & "-(VABRLI/CAPRCO1))/(VABRLI/CAPRCO1),2) End As Porc_Dif_Precios_Bruto,
    ...
    Private Sub Btn_Reabastecer_Bodega_01_Click(sender As Object, e As EventArgs) Handles Btn_Reabastecer_Bodega_01.Click
        ...
        If _TblBodCompra.Rows.Count = 1 Then
            ...
            Consulta_sql = "CREATE TABLE [dbo].[" & _TblPaso & "](
	                        ...
	                        [Stock_CriticoUd" & _Ud & "_Rd]	[float] NOT NULL DEFAULT (0),
	                        [CantComprar]			[float] NOT NULL DEFAULT (0),
	                        [TStock]				[float] NOT NULL DEFAULT (0),
	                        [RotDiariaUd" & _Ud & "]			[float] NOT NULL DEFAULT (0),
	                        [RotMensualUd" & _Ud & "]			[float] NOT NULL DEFAULT (0),
    ...
    Sub Sb_Estudio_NVI_Auto(ByRef _Generar_NVI As GeneraOccAuto.Generar_Doc_Auto)
        ...
        If _TblBodCompra.Rows.Count = 1 Then
            ...
            Consulta_sql = "CREATE TABLE [dbo].[" & _TblPaso & "](
                         ...
                         [Stock_Fisico_Prod]	[float]             NOT NULL DEFAULT (0),
                         [Stock_Disponible]		[float]             NOT NULL DEFAULT (0),
                         [Stock_CriticoUd" & Ud & "_Rd]	[float]             NOT NULL DEFAULT (0),
                         [CantComprar]			[float]             NOT NULL DEFAULT (0),
                         [TStock]				[float]             NOT NULL DEFAULT (0),
                         [RotDiariaUd" & Ud & "]			[float]             NOT NULL DEFAULT (0),
                         [RotMensualUd" & Ud & "]		[float]             NOT NULL DEFAULT (0),
                         [Dias]					[int]               NOT NULL DEFAULT (0),
                         [Solicitar]			[float]             NOT NULL DEFAULT (0),
                         [Pedir]				[float]             NOT NULL DEFAULT (0),
                         [Pedir_Hnos]			[float]             NOT NULL DEFAULT (0),
