...
Public Class Frm_Inf_Vencimientos_Procesar_Informe
    ...
    Private Sub Btn_Procesar_Informe_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Procesar_Informe.Click
        ...
        Consulta_sql = "Select Codigo From " & _Global_BaseBk & "Zw_TblInf_EntExcluidas" & vbCrLf & _
        ...
        _SqlFiltro_Maeedo = _Sql_Entidad_Maeedo & vbCrLf & _
                            _Sql_Sucursal_Maeedo & vbCrLf & _
                            _Sql_Vendedores_Maeedo & vbCrLf & _
                            _SqlFiltro_Entidades_Excluidas_Maeedo

        _SqlFiltro_Maedpce = _Sql_Entidad_Maedpce & vbCrLf & _
                             _Sql_Sucursal_Maedpce & vbCrLf & _
                             _Sql_Vendedores_Maedpce & vbCrLf & _
        ...
        Fm.Sb_Ejecutar_Informe(FormatDateTime(Dtp_Fecha_Desde.Value, DateFormat.ShortDate), _
        ...
        If CBool(Fm.Pro_Tbl_Informe.Rows.Count) Then
            ...
            Fm.ShowDialog(Me)
        Else
            MessageBoxEx.Show(Me, "No hay datos que mostrar", "Informe detallado", _
    ...
    Private Sub Btn_Configuracion_Local_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Configuracion_Local.Click
        ...
        Dim Fm As New Frm_Inf_Vencimientos_Configuracion(_Nombre_Archivo_XML, _
    ...
    Private Sub Rdb_Entidades_Algunas_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Rdb_Entidades_Algunas.CheckedChanged
        ...
        If Rdb_Entidades_Algunas.Checked Then
            ...
            Dim Fm As New Frm_Filtro_Especial_Informes(Frm_Filtro_Especial_Informes._Tabla_Fl._Entidades)
            Fm.Pro_Tbl_Filtro = Nothing
            Fm.ShowDialog(Me)

            If Fm.Pro_Filtrar Then

                _TblFiltro_Entidades = Fm.Pro_Tbl_Filtro
                If (_TblFiltro_Entidades Is Nothing) Or Fm.Pro_Filtrar_Todo Then
