...
Public Class Frm_Licencia_Empresa
    ...
    Public _Primera_Licencia As Boolean
    Public _Actualizar_Licencia As Boolean
    ...
    Private Sub Frm_Licencia_Empresa_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'SELECT Rut,Razon,NombreCorto,Direccion,Giro,Ciudad,Pais,Telefonos,Fecha_caduca,Cant_licencias,Llave1,Llave2,Llave3,Llave4
        'FROM Zw_Licencia

        Dim _TblEmpresa As DataTable = get_Tablas(Consulta_sql, cn1)
    ...
    Private Sub BtnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAceptar.Click
        ...
        If _Llave1 = _Llave1_R And _Llave2 = _Llave2_R And _Llave3 = _Llave3_R And _Llave4 = _Llave4_R Then
            Consulta_sql = "Delete " & _Global_BaseBk & "Zw_Licencia" & vbCrLf & _
                       "Insert Into " & _Global_BaseBk & "Zw_Licencia (Rut,Razon,NombreCorto,Direccion,Giro,Ciudad,Pais,Telefonos," & _
                       "Fecha_caduca,Cant_licencias,Llave1,Llave2,Llave3,Llave4) Values " & vbCrLf & _
                       ...
                       "','" & Txt_Llave3.Text & "','" & Txt_Llave4.Text & "')"
