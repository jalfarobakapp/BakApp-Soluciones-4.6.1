...
#Region "FUNCION CREAR DOCUMENTO RANDOM DEFINITIVO"
    ...
    Function Fx_Crear_Documento(ByVal Tipo_de_documento As String, _
                                ByVal Numero_de_documento As String, _
                                ByVal _Es_ValeTransitorio As Boolean, _
                                ByVal _Es_Documento_Electronico As Boolean, _
                                ByVal Bd_Documento As DataSet, _
        ...
        Try
            ...
            With Tbl_Encabezado
                ...
                Numero_de_documento = Traer_Numero_Documento(_Tido, .Rows(0).Item("NroDocumento"), _Modalidad)

                If String.IsNullOrEmpty(Numero_de_documento) Then
                    Return 0
                End If

                .Rows(0).Item("NroDocumento") = Numero_de_documento
            ...
            Consulta_sql = "INSERT INTO MAEEDO ( EMPRESA,TIDO,NUDO,ENDO,SUENDO )" & vbCrLf & _
            ...
            For Each FDetalle As DataRow In Tbl_Detalle.Rows
                ...
                If Not Estado = DataRowState.Deleted Then
                    ...
                    With FDetalle
                            ...
                            Else
                                ...
                                If _Lincondesp Then
                                    ...
                                    Consulta_sql = "UPDATE MAEPREM SET" & vbCrLf & _
                                                   "STFI1 = STFI1 - " & _Caprco1 & ",STFI2 = STFI2 - " & _Caprco2 & vbCrLf & _
                                                   "WHERE EMPRESA = '" & _Empresa & "' AND KOPR = '" & _Koprct & "'" & vbCrLf & _
                                                   "UPDATE MAEPR SET  STFI1 = STFI1 - " & _Caprco1 & ",STFI2 = STFI2 - " & _Caprco2 & vbCrLf & _
                                                   "WHERE KOPR = '" & _Koprct & "'" & vbCrLf & _
                                                   "UPDATE MAEST SET STFI1 = STFI1 - " & _Caprco1 & ",STFI2 = STFI2 - " & _Caprco2 & vbCrLf & _
                                ...
                                Else
                                    ...
                                    Consulta_sql = "UPDATE MAEPREM SET" & vbCrLf & _
                                                   "STDV1 = STDV1 + " & _Caprco1 & ",STDV2 = STDV2 + " & _Caprco2 & vbCrLf & _
                                                   "WHERE EMPRESA = '" & _Empresa & "' AND KOPR = '" & _Koprct & "'" & vbCrLf & _
                                                   "UPDATE MAEPR SET  STDV1 = STDV1 + " & _Caprco1 & ",STDV2 = STDV2 + " & _Caprco2 & _
                                                   vbCrLf & _
                                                   "WHERE KOPR = '" & _Koprct & "'" & vbCrLf & _
                                                   "UPDATE MAEST SET STDV1 = STDV1 + " & _Caprco1 & ",STDV2 = STDV2 + " & _Caprco2 & _
                                                   vbCrLf & _
                                                   "WHERE EMPRESA='" & _Empresa & "' AND KOSU='" & _Sudo & _
                                                   "' AND KOBO='" & _Bosulido & "' AND KOPR='" & _Koprct & "'"
                        ...
                        If _Tido <> "COV" Then
                            ...
                            If CBool(_Idrst) Then
                                ...
                                If _Tido = "NCC" Or _Tido = "NCV" Then
                                    ...
                                    Consulta_sql = "UPDATE MAEDDO SET CAPRNC1=CAPRNC1+" & _Cant_MovUd1_Ext & _
                                                                    ",CAPRNC2=CAPRNC2+" & _Cant_MovUd2_Ext & "," & _
                                                   "'ESLIDO = " & vbCrLf & _
                                                   "CASE" & vbCrLf & _
                                                   "'WHEN UDTRPR='1' AND CAPRCO1-CAPRAD1-CAPREX1=0 THEN 'C'" & vbCrLf & _
                                                   "'WHEN UDTRPR='2' AND CAPRCO2-CAPRAD2-CAPREX2=0 THEN 'C'" & vbCrLf & _
                                                   "'ELSE ''" & vbCrLf & _
                                                   "END" & vbCrLf & _
                                ...
                                Else
                                    ...
                                    Consulta_sql = "UPDATE MAEDDO SET CAPREX1=CAPREX1+" & _Cant_MovUd1_Ext & _
                                                                    ",CAPREX2=CAPREX2+" & _Cant_MovUd2_Ext & "," & _
                                                   "ESLIDO = " & _
                                                   "CASE" & vbCrLf & _
                                                   "WHEN UDTRPR='1' AND " & _
                                                   "ROUND(CAPRCO1-CAPRAD1-(CAPREX1+" & _Cant_MovUd1_Ext & "),5)=0 THEN 'C'" & vbCrLf & _
                                                   "WHEN UDTRPR='2' AND " & _
                                                   "ROUND(CAPRCO2-CAPRAD2-(CAPREX2+" & _Cant_MovUd2_Ext & "),5)=0 THEN 'C'" & vbCrLf & _
                                                   "Else ''" & vbCrLf & _
                                                   "End" & vbCrLf & _
                        ...
                        Consulta_sql = _
                              "INSERT INTO MAEDDO (IDMAEEDO,ARCHIRST,IDRST,EMPRESA,TIDO,NUDO,ENDO,SUENDO,LILG,NULIDO," & vbCrLf & _
                              ...
                              "EMPREPA,TIDOPA,NUDOPA,ENDOPA,NULIDOPA," & vbCrLf & _
                       ...
                       "VALUES (" & _Idmaeedo & ",'" & _Archirst & "'," & _Idrst & ",'" & _Empresa & "','" & _Tido & "','" & _Nudo & "','" & _Endo & _
                              "','" & _Suendo & "','SI','" & _Nulido & "','" & _Sudo & "','" & _Bosulido & _
                              "','" & _Luvtven & "','" & _Kofulido & "','" & _Tipr & "','" & _Tict & "'," & CInt(_Prct) & ",'" & _Koprct & _
                              ...
                              "," & _Vabrli & ",'I'," & _
                              "'" & _Emprepa & "','" & _Tidopa & "','" & _Nudopa & "','" & _Endopa & "','" & _Nulidopa & "'," & _
                              "'" & _Feemli & "','" & _Feerli & "'," & _Ppprnelt & "," & _Ppprne & _
                        ...
                        If CBool(_Reg) Then
                            ...
                            Consulta_sql = "UPDATE MAEDDO SET PPPRPMIFRS = " & _Ppprpmifrs & vbCrLf & _
                                           "WHERE IDMAEDDO=" & _Idmaeddo
                    ...
                    If Val(_Nuimli) > 0 And String.IsNullOrEmpty(Trim(_Tict)) Then
                        ...
                        For Each FImpto As DataRow In Tbl_Impuestos.Select("Id = " & Id_Linea)
                            ...
                            Consulta_sql = "INSERT INTO MAEIMLI(IDMAEEDO,NULIDO,KOIMLI,POIMLI,VAIMLI,LILG) VALUES " & vbCrLf & _
                    ...
                    If Val(_Nudtli) > 0 And String.IsNullOrEmpty(Trim(_Tict)) Then
                        ...
                        For Each FDscto As DataRow In Tbl_Descuentos.Select("Id = " & Id_Linea)
                            ...
                            Consulta_sql = "INSERT INTO MAEDTLI (IDMAEEDO,NULIDO,KODT,PODT,VADT)" & vbCrLf & _
            ...
            Consulta_sql = Fx_Vencimientos(Tbl_Encabezado.Rows(0))
            ...
            _HoraGrab = Hora_Grab_fx(EsAjuste) 'Math.Round((_HH * 3600) + (_MM * 60) + _SS, 0)
            ...
            Consulta_sql = "UPDATE MAEEDO SET SUENDO='" & _Suendo & "',TIGEDO='I',SUDO='" & _Sudo & _
                    ...
                    For Each _Fila_Idmaeedo As DataRow In _TblOrigen.Rows
                        ...
                        If CBool(_Sum_Caprco) Then
                            ...
                            If _Tido = "NCV" Or _Tido = "NCC" Then
                                ...
                                Consulta_sql = "UPDATE MAEEDO SET CAPREX=CAPREX+0,CAPRNC=CAPRNC+" & _Sum_Caprco_str & ",CAPRAD=CAPRAD+0," & vbCrLf & _
                                               "ESDO=CASE" & vbCrLf & _
                                               "WHEN ROUND(CAPRCO-CAPRAD-CAPREX-(0)-(0),5)=0 THEN 'C'" & vbCrLf & "ELSE ''" & vbCrLf & "END," & vbCrLf & _
                                               "ESFADO=CASE" & vbCrLf & _
                                               "WHEN CAPRCO-CAPRAD-CAPREX-(0)-(0)=0 THEN 'F'" & vbCrLf & "ELSE ESFADO" & vbCrLf & "END" & vbCrLf & _
                                               "WHERE IDMAEEDO= " & _Idmaeedo_Origen
                            Else
                                Consulta_sql = "UPDATE MAEEDO SET CAPREX=CAPREX+" & _Sum_Caprco_str & ",CAPRNC=CAPRNC+0,CAPRAD=CAPRAD+0," & vbCrLf & _
                                               "ESDO=CASE " & vbCrLf & _
                                               "WHEN ROUND(CAPRCO-CAPRAD-CAPREX-(0)-(" & _Sum_Caprco_str & "),5)=0 THEN 'C'" & vbCrLf & "ELSE ''" & vbCrLf & "END," & vbCrLf & _
                                               "ESFADO=" & vbCrLf & _
                                               "CASE" & vbCrLf & _
                                               "WHEN CAPRCO-CAPRAD-CAPREX-(0)-(" & _Sum_Caprco_str & ")=0 THEN 'F'  " & vbCrLf & "ELSE ESFADO" & vbCrLf & "End" & vbCrLf & _
                                               "WHERE IDMAEEDO = " & _Idmaeedo_Origen
                            End If
            ...
            Consulta_sql = Fx_Cambiar_Numeracion_Modalidad(_Tido, _Nudo, Modalidad)
...
#End Region
    ...
    Private Function Fx_Cambiar_Numeracion_Modalidad(ByVal _Tido As String, _
        ...
        If CBool(_Tbl.Rows.Count) Then
            ...
            If String.IsNullOrEmpty(_Nudo_Modalidad) Then
                Fx_Cambiar_Numeracion_Modalidad(_Tido, _Nudo, "  ")
    ...
    Function Fx_Crear_Documento_En_BakApp_Casi(ByVal Bd_Documento As DataSet, _
        ...
        Try
            ...
            With Tbl_Encabezado.Rows(0)
                ...
                _Es_Electronico = CInt(.Item("Es_Electronico")) * -1
        ...
        Try
            ...
            Consulta_sql = "Update " & _Global_BaseBk & "Zw_Casi_DocEnc SET" & vbCrLf & _
                           ...
                           ",Fun_Auto_Deuda_Ven = '" & _Fun_Auto_Deuda_Ven & "'" & vbCrLf & _
                           ",Fun_Auto_Stock_Ins = '" & _Fun_Auto_Stock_Ins & "'" & vbCrLf & _
                           ",Fun_Auto_Cupo_Exe = '" & _Fun_Auto_Cupo_Exe & "'" & vbCrLf & _
...
#Region "EDITAR DOCUMENTO"
    ...
    Function Fx_Editar_Documento(ByVal _Formulario As Form, _
                                 ByVal _Idmaeedo As Integer, _
        ...
        If CBool(_New_Idmaeedo) Then
            ...
            Dim _Eliminado As Boolean = _Class_E.Fx_EliminarAnular_Doc(_Formulario, _
                                                                       _Idmaeedo, _
            ...
            If _Eliminado Then
                ...
                End If
            Else
                _Class_E.Fx_EliminarAnular_Doc(_Formulario, _
                                               _New_Idmaeedo, _
                                               _Cod_Func_Eliminado, _
                                               Clase_EliminarAnular_Documento._Accion_EA.Modificar, _
                                               False)
