...
Public Module Md_Encrypta
    ...
    Function RevisarLlave_BakApp(ByVal Llave As String, _
        ...
        Try
            ...
            Dim sr As New System.IO.StreamReader(Directorio & "\Data\LlaveBk.txt")
            Dim texto = Trim(sr.ReadToEnd())

            If NombreArchivoLlave <> "BakApp" Then
                Desglo_Llave = Split(texto, ";")

                texto = Desglo_Llave(0)
                Dim Fe As Date = CDate(Desglo_Llave(1)) ' CDate("25-07-2014")
            ...
            End If
            sr.Close()
            My.Computer.FileSystem.DeleteFile(Directorio & "\Data\LlaveBk.txt")
