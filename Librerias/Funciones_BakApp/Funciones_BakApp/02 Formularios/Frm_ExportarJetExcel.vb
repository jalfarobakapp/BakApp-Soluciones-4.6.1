...
Public Class Frm_ExportarJetExcel
    ...
    Sub ExpExcelJet(ByVal Tabla As DataTable, _
        ...
        For Each dr In Tabla.Rows
            ...
            For Each dc In Tabla.Columns
                ...
                If ty.Name.ToString = "Double" Or ty.Name.ToString = "Decimal" Then
    ...
    Private Sub BtnDireccionFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDireccionFile.Click
    ...
    Private Sub ToolStripButton3_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.Click
        ...
        CircularProgress2.IsRunning = True
        tb = get_Tablas(Consulta_sql, cn1)
        ExpExcelJet(tb, CircularProgress1, CircularProgress2, "", TxtNombreArchivo.Text)
        CircularProgress2.IsRunning = False
        Cancelar = False
        Procesando(True, Cancelar)
    End Sub
