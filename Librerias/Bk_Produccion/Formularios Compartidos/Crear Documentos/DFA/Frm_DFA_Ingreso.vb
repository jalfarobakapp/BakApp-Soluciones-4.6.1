        ...
        If e.KeyValue = Keys.Enter Then
            ...
            If _Es_Inicio Then
                ...
                If _Realizado > 0 Then
                    If _Fabricar <= _Realizado Then
                        ...
                        Dim Pregunta = MessageBoxEx.Show(Me, "Esta operación se encuentra realizada." & vbCrLf & vbCrLf &
            ...
            Else
                ...
                Else
                    ...
                    MessageBoxEx.Show(Me, "Solo se pueden ingresar Datos de Fabricación para Ordenes de Trabajo Vigente",
        ...
        If _Estado = "V" Then
            ...
            If Not (_Row_SubOt Is Nothing) Then
                ...
                Else
                    ...
                    MessageBoxEx.Show(Me, "Esta operación se encuentra en curso" & vbCrLf &
                                     "Para iniciar el proceso nuevamente debe cerrar la operación anterior",
    ...
    Private Sub Sb_Txt_Leer_SubOT_Pistoleado_Fin(ByVal _Row_Ot As DataRow,
        ...
        If _Estado = "V" Then
            ...
            If Not (_Row_SubOt Is Nothing) Then
                ...
                If Not (_Row_Dfa_Espera Is Nothing) Then
                    ...
                    If _Tbl.Rows.Count = 1 Then
                        ...
                        If _Fechini <> _Fecha_Hoy Then
                            ...
                            MessageBoxEx.Show(Me, "Esta operación está atrasada, debe cerrarse con los antecedentes del día en que fue abierta.",
                                              "Validación", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                ...
                Else
                    MessageBoxEx.Show(Me, "Esta operación aun no ha sido iniciada", "Validación",
        ...
        Else
            ...
            If Not (_Row_Maquina Is Nothing) Then
                ...
                If CBool(_Tbl_Operaciones.Rows.Count) Then
                    ...
                    Else
                        MessageBoxEx.Show(Me, "NO SE SELECCIONO NINGUNA OPERACION", "Validación",
                                          MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    End If
        ...
        If Not (_Row_Operario Is Nothing) Then
            ...
            If Not _Acepta_estar_en_mas_de_una_maquina Then
                ...
                If CBool(_Oper_Abiertas) Then
                    ...
                    If _Oper_Abiertas_Otros_dias = 1 Then
                        MessageBoxEx.Show(Me, "¡Existe 1 operación que aún no ha sido cerrada por usted en otro día!" & vbCrLf & vbCrLf &
                        "Ahora podrá registrar este trabajo, pero debe informar a la administración para cerrar la orden pendiente." & vbCrLf &
                        "Si tiene más de una orden pendiente no podrá ingresar más tareas hasta que no haya solucionado el problema",
                        "VALIDACION", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                    Else
                        'If (_Oper_Abiertas_Hoy_Otras_Maquinas + _Oper_Abiertas_Otros_dias) > 1 Then
                        If (_Oper_Abiertas_Hoy_Otras_Maquinas + _Oper_Abiertas_Otros_dias) > 1 Then
                            MessageBoxEx.Show(Me, "Existen " & _Oper_Abiertas & " operaciones que aún no han sido cerradas por usted de otros días." & vbCrLf &
                                              "Para poder continuar debe dirigirse a la administración para que cierren las ordenes y luego podrá ingresar un trabajo." & vbCrLf & vbCrLf &
            ...
            If _Multicarga = "S" Then
                If _Fabricando > _Capacidad Then
                    MessageBoxEx.Show(Me, "La máquina esta sobre cargada según datos de parametrización" & vbCrLf & vbCrLf &
                                      "Capacidad máxima " & FormatNumber(_Capacidad, 0) & Space(1) & _Udadcarga & vbCrLf &
                                      "Cantidad que está siendo fabricada: " & FormatNumber(_Fabricando, 0) & Space(1) & _Udadcarga & vbCrLf & vbCrLf &
                                      "¡LOS DATOS NO SERAN GUARDADOS!", "VALIDACION", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Return
                End If
            Else
                MessageBoxEx.Show(Me, "La máquina  [" & _Nombremaq & "] no acepta sobre carga según datos de parametrización" & vbCrLf &
                            "Para poder continuar debe dirigirse a la administración para que cierren las ordenes y luego podrá ingresar un trabajo." & vbCrLf & vbCrLf &
                             "¡LOS DATOS NO SERAN GUARDADOS!",
                             "VALIDACION", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Return
            ...
            Else
                ...
                If CBool(foundRows.Length) Then
                    MessageBoxEx.Show(Me, "Este operario ya esta en la lista", "Validación",
                                      MessageBoxButtons.OK, MessageBoxIcon.Stop)
                    Sb_Agregar_Operario(_Idpdatfad, _Cierre, _Preguntar_Agrega_Otro_Operario, _Row_Maquina, Chk_Acepta_estar_en_mas_de_una_maquina.Checked)
                Else
                    If Fx_Ingresar_Nuevo_Operario_POBREFAD(_Idpdatfad, _Row_Operario, _Cierre) Then
                        If _Preguntar_Agrega_Otro_Operario Then
                            If MessageBoxEx.Show(Me, "¿Desea ingresar otro operario a la DFA?", "Ingreso de operarios",
